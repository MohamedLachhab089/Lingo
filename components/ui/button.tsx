...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase",
  {
    variants: {
      variant: {
        ...
        danger: "bg-rose-500 text-primary-foreground hover:bg-red-400/90 border-rose-500 border-b-4 active:border-b-0",
        dangerOutline: "text-rose-500 bg-white hover:bg-slate-100",
        super: "bg-indigo-500 text-primary-foreground hover:bg-indigo-400/90 border-indigo-500 border-b-4 active:border-b-0",
